...
import "./MyLoop.sol"; // how to import from my own files
...
contract MyImport is ERC721, MyLoop {
    ...
    bytes32 myBytesName = "Daniel"; // eat less gas
    ...
    function myHashedName(string memory _name) public pure returns (bytes32) {
        return keccak256(abi.encodePacked(_name)); //extra library abi.encodePacked bytes32
    }
